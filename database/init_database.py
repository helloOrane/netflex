...
# creation de la table User_account (colonnes: User_id, Name, Email, Password, Country, Gender, Age)
...
# pd.DataFrame(columns=['User_id', 'Name', 'Email', 'Password', 'Country','Gender', 'Age'], data=user_account_test).to_sql('User_account', con=engine, if_exists='replace', index=True)
